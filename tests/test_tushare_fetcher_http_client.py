...
from src.stock_analysis_skill.providers.tushare_fetcher import TushareFetcher, _TushareHttpClient
...
class TestTushareHttpClient(unittest.TestCase):
    ...
    def test_query_posts_to_official_pro_endpoint(self) -> None:
        ...
        with patch("src.stock_analysis_skill.providers.tushare_fetcher.requests.post", return_value=response) as post_mock:
...
class TestTushareFetcherInit(unittest.TestCase):
    ...
    def test_init_builds_http_client_when_token_present(self) -> None:
        ...
        with patch("src.stock_analysis_skill.providers.tushare_fetcher.get_config", return_value=config):
