# -*- coding: utf-8 -*-
"""Prompt-body assembly helpers for stock analysis."""
...
from src.report_language import get_no_data_text, get_unknown_text, normalize_report_language
from .presentation import format_amount, format_volume
