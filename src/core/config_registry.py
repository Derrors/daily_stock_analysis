...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "title": "Data Source",
        "description": "Runtime data/search provider credentials and quote controls.",
        "display_order": 30,
    },
    {
        "category": "system",
        "title": "System",
        "description": "Skill runtime, reporting, and scheduling controls.",
        "display_order": 50,
    },
    {
        "category": "agent",
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "REPORT_SUMMARY_ONLY": {
        ...
        "description": "Output only the analysis summary without per-stock details. Suitable for quick overview when tracking many stocks (Issue #262).",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "REPORT_LANGUAGE": {
        ...
        "description": "Default output language for reports. Supported values: zh, en.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "FEISHU_APP_ID": {
        "title": "Feishu App ID",
        "description": "Feishu app ID used for cloud document integration.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FEISHU_APP_SECRET": {
        ...
        "description": "Feishu app secret used for cloud document integration.",
        "category": "system",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FEISHU_FOLDER_TOKEN": {
        ...
        "description": "Target Feishu folder token for saving generated cloud documents.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SCHEDULE_RUN_IMMEDIATELY": {
        ...
        "description": "Canonical startup flag for schedule mode.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
...
def _infer_category(key: str) -> str:
    ...
    if key.endswith("_PRIORITY") or key.startswith(
        ...
        return "data_source"
    if key.startswith(("LOG_", "SCHEDULE_", "HTTP_", "HTTPS_", "MAX_", "DEBUG", "MARKET_REVIEW_", "TRADING_DAY_", "ANALYSIS_DELAY", "FEISHU_", "REPORT_", "SAVE_CONTEXT_", "DATABASE_", "SQLITE_", "CONFIG_VALIDATE_")):
        return "system"
